package com.jialli.first_ai_project.chat.advisor;
...
//        existingMessages.add(new SystemMessage("please don't answer" +
//            " not summarization questions, and reply I can only help with summarization tasks."+existingSystemMessage));
        ...
        log.info("SystemMessage is updated as : {} ",  systemMessage);
