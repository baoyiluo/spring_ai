package com.jialli.first_ai_project.chat.dockermodelrunner;
...
public class DockerModelRunnerController {
    ...
    private static final String SYSTEM_PROMPT1 = "You are a helpful assistant that generates professional LinkedIn posts about technical subjects." +
