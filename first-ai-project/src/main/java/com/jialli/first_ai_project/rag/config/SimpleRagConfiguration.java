package com.jialli.first_ai_project.rag.config;
...
public class SimpleRagConfiguration {
    ...
    private static final String VECTOR_STORE_PATH = "first-ai-project/src/main/resources/rag/mini-employee-handbook/vector-store/vectorstore.json";

    @Bean
    public SimpleVectorStore simpleVectorStore(@Qualifier("openAiEmbeddingModel") EmbeddingModel embeddingModel, //@Qulifier("openAiEmbeddingModel")
